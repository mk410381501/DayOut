...
<body>
	...
	<div class="slide" id="slide3" data-slide="3" data-stellar-background-ratio="0.8">
		<div class="container clearfix">
...
<p>The oldest classical Greek and Latin writing had little or no spaces between words, and could be written in boustrophedon (alternating directions). Over time, text direction (left to right) became standardized, and word dividers and terminal punctuation became common.</p>
	...
	<div class="slide" id="slide4" data-slide="4" data-stellar-background-ratio="0.8">
		<div class="container clearfix">
			...
			<div id="content" class="grid_12">
				<h3>Pricing</h3>
		<p>Beta launch is free to all members.</p>
        <br> </br>
        <p><img src="http://4.bp.blogspot.com/-obLSKykwiHA/UHEZR2Iry4I/AAAAAAAAFQ4/ZcNrQBX5hdg/s1600/comingsoon_stamp.png" /></p>
	...
	<div class="container clearfix">
		...
		<ul class="footer_links">
			...
			<li><a href="#slide3">About Us</a></li>
           <li><a href="#slide4">Pricing</a></li>
